            ...
            <nav class="navigation">
                <ul>
                    ...
                    <li
                        ...
                        <a href="/admin/property/types" title="Propert Types"><span
                                class="nav-icon material-icons">widgets</span>
                            Property Types</a>
                    </li>
                    ...
                    <li
                        ...
                        <a href="/admin/properties" title="Properties"><span
                                class="nav-icon material-icons">widgets</span>
                            Properties</a>
                    </li>
                    ...
                    {{-- <li
                        class="{{ request()->route() && request()->route()->uri() == 'admin/properties_booked' ? 'active' : '' }}">
                        <a href="/admin/properties_booked" title="Contacts"><span
                                class="nav-icon material-icons">widgets</span>
                            Properties Booked</a>
                    </li> --}}

                    {{-- <li
                        class="{{ request()->route() && request()->route()->uri() == 'admin/transactions' ? 'active' : '' }}">
